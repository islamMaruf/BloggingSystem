...
@section('header-section')
    <div class="page-header header-filter" data-parallax="true" style="background-image: url('{{asset('assets/font-end')}}/assets/img/bg5.jpg');">
        <div class="container">
            <div class="row">
    ...
    <div class="section section-text">
        <div class="row">
            ...
            <div class="section col-md-10 ml-auto mr-auto">
                <div class="row">
                    <div class="col-md-4">
                        <img class="img-raised rounded img-fluid" alt="Raised Image" src="{{asset('assets/font-end')}}/assets/img/examples/blog4.jpg">
                    </div>
                    <div class="col-md-4">
                        <img class="img-raised rounded img-fluid" alt="Raised Image" src="{{asset('assets/font-end')}}/assets/img/examples/blog3.jpg">
                    </div>
                    <div class="col-md-4">
                        <img class="img-raised rounded img-fluid" alt="Raised Image" src="{{asset('assets/font-end')}}/assets/img/examples/blog1.jpg">
                    </div>
                </div>
            </div>
            <div class="col-md-8 ml-auto mr-auto">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img" src="{{asset('assets/font-end')}}/assets/img/faces/card-profile1-square.jpg">
                                </a>
            ...
            <div class="col-md-8 ml-auto mr-auto">
                <div class="media-area">
                    ...
                    <div class="media">
                        <a class="float-left" href="#pablo">
                            <div class="avatar">
                                <img class="media-object" src="{{asset('assets/font-end')}}/assets/img/faces/card-profile4-square.jpg" alt="...">
                            </div>
                        </a>
                    ...
                    <div class="media">
                        <a class="float-left" href="#pablo">
                            <div class="avatar">
                                <img class="media-object" alt="Tim Picture" src="{{asset('assets/font-end')}}/assets/img/faces/card-profile1-square.jpg">
                            </div>
                        </a>
                        <div class="media-body">
                            ...
                            <div class="media">
                                <a class="float-left" href="#pablo">
                                    <div class="avatar">
                                        <img class="media-object" alt="64x64" src="{{asset('assets/font-end')}}/assets/img/faces/card-profile4-square.jpg">
                                    </div>
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading">Tina Andrew
                ...
                <div class="media media-post">
                    <a class="author float-left" href="#pablo">
                        <div class="avatar">
                            <img class="media-object" alt="64x64" src="{{asset('assets/font-end')}}/assets/img/faces/card-profile6-square.jpg">
                        </div>
                    </a>
                    <div class="media-body">
