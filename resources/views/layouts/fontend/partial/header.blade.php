    ...
    <div id="nav">
        ...
        <div id="nav-top">
            <div class="container">
                ...
                <!-- logo -->
                <div class="nav-logo">
                    <a href="index.html" class="logo"><img src="{{asset('assets/font-end')}}/img/logo.png" alt=""></a>
                </div>
                <!-- /logo -->
                                    ...
                                    <div class="dropdown-body tab-content">
                                        ...
                                        <div id="tab1" class="tab-pane fade in active">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img src="{{asset('assets/font-end')}}/img/post-12.jpg" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
                                                                <a href="category.html">Lifestyle</a>
                                                            </div>
                                        ...
                                        <div id="tab2" class="tab-pane fade in">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img src="{{asset('assets/font-end')}}/img/post-5.jpg" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
                                                                <a href="category.html">Lifestyle</a>
                                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="post post-sm">
                                                        <a class="post-img" href="blog-post.html"><img src="{{asset('assets/font-end')}}/img/post-8.jpg" alt=""></a>
                                                        <div class="post-body">
                                                            <div class="post-category">
