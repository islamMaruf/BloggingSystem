        ...
        <div id="hot-post" class="row hot-post">
            <div class="col-md-8 hot-post-left">
                ...
                <div class="post post-thumb">
                    <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/hot-post-1.jpg" alt=""></a>
                    <div class="post-body">
            ...
            <div class="col-md-4 hot-post-right">
                <!-- post -->
                <div class="post post-thumb">
                    <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/hot-post-3.jpg" alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="post">
                            <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/post-1.jpg" alt=""></a>
                            <div class="post-body">
                                <div class="post-category">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="post post-sm">
                            <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/post-9.jpg" alt=""></a>
                            <div class="post-body">
                                <div class="post-category">
                                    <a href="category.html">Lifestyle</a>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="post post-sm">
                            <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/post-10.jpg" alt=""></a>
                            <div class="post-body">
                                <div class="post-category">
                                    <a href="category.html">Travel</a>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="post post-sm">
                            <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/post-4.jpg" alt=""></a>
                            <div class="post-body">
                                <div class="post-category">
            ...
            @include('layouts.fontend.widget')
        </div>
        <!-- /row -->
    </div>
    <!-- /container -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="post post-row">
                    <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/post-13.jpg" alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
                            <a href="category.html">Travel</a>
                            <a href="category.html">Lifestyle</a>
               ...
               <!-- post -->
                <div class="post post-row">
                    <a class="post-img" href="blog-post.html"><img src="{{asset('assets')}}/font-end/img/post-7.jpg" alt=""></a>
                    <div class="post-body">
                        <div class="post-category">
                            <a href="category.html">Health</a>
                            <a href="category.html">Lifestyle</a>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam...</p>
                        <a href="#" class="primary-button loadmore">Read More</a>
                    </div>
                </div>
                <!-- /post -->
