...
<div class="content">
    <div class="container-fluid">
        <form id="RegisterValidation" action="{{route('author.posts.store')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" class="form-control" required="true" aria-required="true" name="title">
                            </div>
                        ...
                        <div class="card-footer text-right text-info">
                            <div class="form-check mr-auto">
                                <label class="form-check-label" id="lebel">
                                    <input class="form-check-input" name="publish" type="checkbox" value="1" aria-required="true" onclick="toggle()">Published
                ...
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <textarea name="body" id="tiny" ></textarea>
                        </div>
