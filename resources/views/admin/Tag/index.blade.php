                                    ...
                                    @foreach($tags as $tag)
                                        <tr>
                                            ...
                                            <td class="td-actions text-center">
                                                <a href="{{route('admin.tags.edit',$tag->id)}}" class="btn btn-success btn-round edit" ><i class="material-icons">edit</i></a>
                                                <a class="btn btn btn-danger btn-round remove" onclick="deleteTag({{$tag->id}})"><i class="material-icons">close</i></a>
