...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <form id="RegisterValidation" action="{{route('admin.posts.update',$post->id)}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input type="text" class="form-control" required="true" aria-required="true" name="title" value="{{$post->title}}">
                                </div>
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="{{asset('storage/post/'.$post->image)}}" alt="img_source" height="120px" width="120px">
                                    </div>
                            ...
                            <div class="card-footer text-right text-info">
                                <div class="form-check mr-auto">
                                    <label class="form-check-label" id="lebel">
                                        <input class="form-check-input" name="publish" type="checkbox" {{$post->status ? 'checked': ''}}   aria-required="true" onclick="toggle()">Published
                            ...
                            <div class="card-body ">
                                <div class="row ">
                                    <div class="col-lg-5 col-md-6 col-sm-3 ml-auto mr-auto">
                                        <select class="selectpicker" data-style="btn btn-primary" multiple title="Choose Category" data-size="" name="category[]">
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-3 ml-auto mr-auto">
                                        <select class="selectpicker" data-style="btn btn-primary" multiple title="Choose Tag" data-size="" name="tag[]">
                                            <option disabled> Multiple Options</option>
                                            @foreach($tags as $tag)
                                                <option
